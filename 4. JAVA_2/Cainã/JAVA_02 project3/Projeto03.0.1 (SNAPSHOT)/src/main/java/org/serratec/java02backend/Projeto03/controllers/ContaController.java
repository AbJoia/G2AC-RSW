...
public class ContaController {
	...
	public Conta getUmaConta(@PathVariable int id) throws IdInvalidoException {
	...
	public Conta updateConta(@PathVariable int id, @RequestBody Conta newConta) throws IdInvalidoException {
		return contaService.updateConta(id, newConta);
	}

	@DeleteMapping("/contas/{id}")
	public Conta deleteConta(@PathVariable int id) throws IdInvalidoException {
		return contaService.deleteConta(id);
	}

	@PostMapping("/contas/{id}/{op}")
	public Conta atualizaSaldo(@PathVariable int id, @PathVariable String op, @RequestParam double valor)
			throws ValorInvalidoException, OperacaoInvalidaException, IdInvalidoException {
